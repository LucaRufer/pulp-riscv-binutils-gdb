...
#define CSR_MHPM_VALID 0x7d2
#define CSR_MHPMH_VALID 0x7d3
#define CSR_DMR_STS 0x7d4
...
DECLARE_CSR(mhpm_valid, CSR_MHPM_VALID)
DECLARE_CSR(mhpmh_valid, CSR_MHPMH_VALID)
DECLARE_CSR(dmr_sts, CSR_DMR_STS)
